...
function bannerTracking() {
  return (
    <div className="h-[480px] bg-indigo-600 mt-[-50px]">
      <h1 className="relative text-lx text-center mb-24 text-2xl font-bold text-white">
        Como rastrear objetos, encomendas ou pacotes no axeicaixa em 3 passos:
      </h1>
      <div className="flex w-full">
        <card className="bg-indigo-600 w-1/3 text-center h-full mx-7">
          <h2 className="text-white font-bold text-lg mb-12">
          ...
          <p className="text-white mt-4 font-medium text-[15px]">
