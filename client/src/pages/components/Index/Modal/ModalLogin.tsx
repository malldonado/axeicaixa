      ...
      <div className='w-[90%] mt-8 mx-auto mb-auto h-full p-0 z-[1000] overflow-y-hidden'>
        ...
        <div className="mt-10">
          ...
          <form className="mt-6 m-auto" action="">
            ...
            <p className="mt-4 nunito-font text-black text-[14px] font-normal">
                Don't have an account? <a className='text-[#4f46e5] cursor-pointer text-[15px] font-bold' href="">Sign up</a>
            </p>
          </form>
        </div>
      </div>
