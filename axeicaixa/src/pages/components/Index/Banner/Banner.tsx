        ...
        <div className="sm:text-center lg:text-left">
            ...
            <form method="post" action="/tracking">
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                    <input name="dados" className="w-full placeholder:text-indigo-600 rounded-xl mr-2.5 p-2.5 border-2 font-sans font-medium text-lg text-indigo-700 border-indigo-600 bg-indigo-white" placeholder="Digite seu código de rastreio"></input>
